...
#include "interfaces/srv/detail/myimage__rosidl_typesupport_fastrtps_c.h"
...
using _Myimage_Request__ros_msg_type = interfaces__srv__Myimage_Request;
...
size_t get_serialized_size_interfaces__srv__Myimage_Request(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Myimage_Request__ros_msg_type * ros_message = static_cast<const _Myimage_Request__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _Myimage_Request__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_interfaces__srv__Myimage_Request(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_interfaces
size_t max_serialized_size_interfaces__srv__Myimage_Request(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = interfaces__srv__Myimage_Request;
    is_plain =
      (
...
static size_t _Myimage_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_interfaces__srv__Myimage_Request(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, interfaces, srv, Myimage_Request)() {
...
using _Myimage_Response__ros_msg_type = interfaces__srv__Myimage_Response;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_interfaces
size_t get_serialized_size_interfaces__srv__Myimage_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Myimage_Response__ros_msg_type * ros_message = static_cast<const _Myimage_Response__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_interfaces__srv__Myimage_Response(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_interfaces
size_t max_serialized_size_interfaces__srv__Myimage_Response(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = interfaces__srv__Myimage_Response;
    is_plain =
      (
...
static size_t _Myimage_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_interfaces__srv__Myimage_Response(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, interfaces, srv, Myimage_Response)() {
...
// already included above
// #include "interfaces/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
#include "interfaces/srv/myimage.h"
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, interfaces, srv, Myimage)() {
