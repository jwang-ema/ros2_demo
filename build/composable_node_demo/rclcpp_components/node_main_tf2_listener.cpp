...
#define NODE_MAIN_LOGGER_NAME "tf2_listener"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libtf2_listener_component.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<TF2Listener>";
