...
#define NODE_MAIN_LOGGER_NAME "client_node"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libclient_node_component.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<ClientNode>";
