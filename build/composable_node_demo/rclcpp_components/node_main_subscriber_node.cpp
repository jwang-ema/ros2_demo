...
#define NODE_MAIN_LOGGER_NAME "subscriber_node"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libsubscriber_node_component.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<SubscriberNode>";
