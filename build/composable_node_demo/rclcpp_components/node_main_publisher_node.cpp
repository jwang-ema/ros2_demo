...
#define NODE_MAIN_LOGGER_NAME "publisher_node"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libpublisher_node_component.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<PublisherNode>";
