...
class Metaclass_Myimage(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from interfaces.srv import _myimage
...
class Myimage(metaclass=Metaclass_Myimage):
    from interfaces.srv._myimage import Myimage_Request as Request
    from interfaces.srv._myimage import Myimage_Response as Response
